About cuda-api-wrappers-feedstock
=================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/cuda-api-wrappers-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/cuda-api-wrappers-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add cuda-api-wrappers
# for installing globally
pixi global install cuda-api-wrappers
```
...
It is possible to list all of the versions of `cuda-api-wrappers` available on your platform:
...
```
pixi search cuda-api-wrappers --channel conda-forge
```
